...
Revision ID: 028f2a1ffc42
Revises: 2949a2b2fdcd
Create Date: 2022-12-09 05:15:49.848796
...
revision = '028f2a1ffc42'
down_revision = '2949a2b2fdcd'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('acces', sa.Integer(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
